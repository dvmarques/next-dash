...
import NMainChart from './MainChart';
import NWidgetsBrand from './WidgetsBrand';
import NWidgetsDropdown from './WidgetsDropdown';
...
export default function NDashboard() {
	...
	return (
		<>
			<NWidgetsDropdown className="mb-4" />
			...
			<NWidgetsBrand className="mb-4" withCharts />
			<CRow>
				<CCol xs>
					<CCard className="mb-4">
